...
public enum PortfolioErrorCode implements ErrorCode {
    ...
    PORTFOLIO_ALREADY_EXISTS("PORTFOLIO-003", "이미 포트폴리오가 존재합니다.", HttpStatus.CONFLICT),
    TRADE_ACCOUNT_NOT_FOUND("PORTFOLIO-004", "투자 계좌를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    PORTFOLIO_ANALYSIS_NOT_FOUND("PORTFOLIO-005", "포트폴리오 AI 분석 결과를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    PORTFOLIO_ANALYSIS_DAILY_LIMIT_EXCEEDED("PORTFOLIO-006", "포트폴리오 AI 분석은 하루에 한 번만 요청할 수 있습니다.", HttpStatus.TOO_MANY_REQUESTS),
    PORTFOLIO_ANALYSIS_FREE_LIMIT_EXCEEDED("PORTFOLIO-007", "무료 플랜의 포트폴리오 AI 분석 가능 횟수를 초과했습니다.", HttpStatus.FORBIDDEN),
