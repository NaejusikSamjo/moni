...
public enum PortfolioErrorCode implements ErrorCode {
    ...
    STOCK_SERVICE_ERROR("PORTFOLIO-902", "Stock 서비스 연동 중 오류가 발생했습니다.", HttpStatus.BAD_GATEWAY),
    TRADE_SERVICE_TIMEOUT("PORTFOLIO-903", "Trade 서비스 응답 시간이 초과되었습니다.", HttpStatus.GATEWAY_TIMEOUT),
